                            ...
                            <tbody>
                              {
                                products.map((item, index) => {
                                  ...
                                  const totalRegularPrice = item.sizeDetails?.reduce((acc, sizeDetail) => acc + sizeDetail?.regularPrice, 0) || 0;
                                  const totalSellingPrice = item.sizeDetails?.reduce((acc, sizeDetail) => acc + sizeDetail?.salePrice, 0) || 0;
                                  const totalPurchasePrice = item.sizeDetails?.reduce((acc, sizeDetail) => acc + sizeDetail?.purchasePrice, 0) || 0;
                                  const totalWholeSalePrice = item.sizeDetails?.reduce((acc, sizeDetail) => acc + sizeDetail?.wholesalePrice, 0) || 0;
                                  const totalOSPPrice = item.sizeDetails?.reduce((acc, sizeDetail) => acc + sizeDetail?.ospPrice, 0) || 0;
