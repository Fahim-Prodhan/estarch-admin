...
function EditProduct() {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch(`${baseUrl}/api/products/products/${id}`, {
        method: 'PUT',
        headers: {
              ...
              <div className="bg-neutral-focus p-4 rounded-lg ">
                <form className="space-y-4 border shadow-xl ">
                  ...
                  <div className='flex justify-center items-center'>
                    ...
                    <input value={productName} onChange={(e) => setProductName(e.target.value)} type="text" name='productName' id="productName" className="input input-bordered w-[600px]" required />
                  </div>
                  <div className='flex justify-center items-center'>
                    <label className=" w-80 text-sm font-medium text-gray-700" htmlFor="category">Type</label>
                    <select value={selectedType} onChange={(e) => setSelectedType(e.target.value)} id="Type" className="select select-bordered w-[600px]">
                  ...
                  <div className='flex justify-center items-center'>
                    ...
                    <select value={selectedSubCategory} onChange={(e) => setSelectedSubCategory(e.target.value)} id="Sub Category" className="select select-bordered w-[600px]">
                  ...
                  <div className='flex justify-center items-center'>
                    ...
                    <select value={selectedBrand} onChange={(e) => setSelectedBrand(e.target.value)} id="brand" className="select select-bordered w-[600px]">
                  ...
                  <div className='flex justify-center items-center'>
                    ...
                    <input value={'pc'} type="text" id="unit" placeholder="Unit (kg, pc, etc)" className="input input-bordered w-[600px]" />
                  </div>
              ...
              <div className="bg-neutral-focus p-4 rounded-lg">
                <form className="space-y-4 border shadow-xl">
                  <div className="flex justify-between items-center mb-4 bg-sky-950 text-2xl py-5 px-4">
                    ...
                    <input defaultChecked={showSize} type="checkbox" className="toggle toggle-primary" onChange={() => setShowSize(!showSize)} />
                  </div>
                  <div className="flex justify-center items-center">
