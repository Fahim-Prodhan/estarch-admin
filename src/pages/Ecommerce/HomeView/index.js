...
const HomeView = () => {
  ...
  document.title = "Estarch | Home View"
  ...
  return (
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Estarch" breadcrumbItem="Home View" />
          <div className="p-10">
            {/* Header */}
            <div className="bg-blue-900 text-white p-4 rounded-md mb-6">
              <h2 className="text-lg font-semibold text-white">Home View</h2>
            </div>
        ...
        >
          Save
            ...
            <p className='text-center my-6 font-bold text-lg'>Extra Section Handle</p>
            <ExtraSection />
          </div>
        </Container>
      </div>
