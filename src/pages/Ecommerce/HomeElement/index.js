...
// const HomeElement = () => {
//     const [visibleSection, setVisibleSection] = useState('carousel');
...
//                         <button
//                             className={`bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-200 ${visibleSection === 'carousel' ? 'bg-blue-700' : ''}`}
//                             onClick={() => setVisibleSection('carousel')}
//                         >
//                             Carousel
//                         </button>
//                         <button
//                             className={`bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-200 ${visibleSection === 'homeImage' ? 'bg-blue-700' : ''}`}
//                             onClick={() => setVisibleSection('homeImage')}
//                         >
//                             Home Image
//                         </button>
//                         <button
//                             className={`bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-200 ${visibleSection === 'video' ? 'bg-blue-700' : ''}`}
//                             onClick={() => setVisibleSection('video')}
//                         >
//                             Video
//                         </button>
//                     </div>
