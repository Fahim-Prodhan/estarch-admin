  ...
  return (
    <React.Fragment>
      <header id="page-topbar">
        <div className="navbar-header justify-start md:justify-between">
          <div className="d-flex">
            <div className="navbar-brand-box">
              <Link to="/" className="logo logo-dark">
                <span className="logo-sm">
                  <img className='w-4 mt-4' src={logoSm} alt="" height="22" />
                </span>
            ...
            <button
              ...
              className="px-3 font-size-16 header-item waves-effect vertical-menu-btn"
          ...
          <div className="d-flex flex gap-4">
                  ...
                  <div className="form-group m-0">
                    <div className="input-group">
                      ...
                      <div className="input-group-append">
                        <Button className="" type="submit"><i className="mdi mdi-magnify"></i></Button>
                      </div>
                    </div>
                  </div>
                </Form>
            ...
            <div onClick={() => {
              ...
              <button type="button" className="header-item noti-icon right-bar-toggle waves-effect">
